...
import i_user_check from './svg/i-user-check';
...
import i_time_1 from './svg/i-time_1';
import i_transfer from './svg/i-transfer';
import i_time from './svg/i-time';
import i_text from './svg/i-text';
import i_terminal from './svg/i-terminal';
import i_tick_double from './svg/i-tick-double';
import i_terraform from './svg/i-terraform';
...
import i_square from './svg/i-square';
...
import i_share from './svg/i-share';
...
import i_policy from './svg/i-policy';
...
import i_lock_1 from './svg/i-lock_1';
...
import i_github from './svg/i-github';
...
import i_big_number from './svg/i-big-number';
...
import i_account from './svg/i-account';
...
const IconPack = {
    ...
    'i-time': i_time,
    'i-text': i_text,
    'i-terminal': i_terminal,
    'i-tick-double': i_tick_double,
    'i-terraform': i_terraform,
