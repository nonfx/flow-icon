...
import FlowEngIconPack from "@ollion/flow-engineering-icon/icon-pack";
...
import FlowEngIconPackageJSON from "@ollion/flow-engineering-icon/package.json";
...
@customElement("flow-eng-icons")
export class FlowEngIconStoryElement extends LitElement {
  searchTerm: string = null;
    ...
    return html`
      ...
      >
        <f-text style="width:100%" align="center"
          ...
          ${FlowEngIconPackageJSON.version}</f-text
        >
        <f-search
          .value=${this.searchTerm}
          @keydown=${this.handleKeydown}
